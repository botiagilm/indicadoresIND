	...
	<input type="hidden" value="" id="indicador_id" />
            <div class="row" id="op_data">
                <div class="col-12 text-center">
                    <h1 id="ln_wc" class="all_label2 extra_all2">PRENSA 1</h1>
                </div>
                <div class="col-12 text-center">
                    <table width="100%">
                        <thead id="tbl_head">
                            <tr class="table_tr">
                                <th class="all_label HeadLine_2">Serie</th>
                                <th class="all_label HeadLine_2">Tiempo STD</th>
                                <th class="all_label HeadLine_2">FI. Precalentado</th>
                                <th class="all_label HeadLine_2">T. Precalentado</th>
                            </tr>
                        </thead>
                        <tbody id="tbl_body">

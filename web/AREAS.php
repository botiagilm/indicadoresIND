...
<header class="flex justify-between items-center bg-slate-800/80 backdrop-blur px-6 py-3 rounded-xl border border-slate-700 h-[10%] shadow-lg">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl uppercase tracking-widest text-slate-200 leading-none">Estatus General</h1>
            <p class="text-xs text-slate-400 uppercase tracking-wider mt-1">Monitoreo en Tiempo Real</p>
        </div>
    </div>
...
<script>
    ...
    function exec_getdata() {
        ...
        formData.append("INDICADOR", "AREAS");
